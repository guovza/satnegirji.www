Web-version of Suoma-Sáme-Suoma sátnegirji with PHP and SQLite. This version is still under development but published in the hope it's helpful for you. The search already works quite well but some additional features are still in progress.
